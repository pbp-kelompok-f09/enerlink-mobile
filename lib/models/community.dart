...
class CommunityFields {
  ...
  factory CommunityFields.fromJson(Map<String, dynamic> json) {
    // Default image if profile picture is null
    const String defaultProfilePicture = 'https://res.cloudinary.com/dwnuf9cop/image/upload/v1701386453/media/noProfile.jpg';
    ...
    return CommunityFields(
        ...
        adminCommunityProfilePicture: json["admin_community_profile_picture"] ?? defaultProfilePicture,
